...
open class Parallelepiped : ThreeDimensionalMutableFigure {
    ...
    open val topBrink: Rectangle
    open val bottomBrink: Rectangle
    open val leftBrink: Rectangle
    open val rightBrink: Rectangle
    open val frontBrink: Rectangle
    open val behindBrink: Rectangle
    ...
    fun getCenter(): Vector3d =
        Vector3d(
            Line(frontBrink.point1, behindBrink.point4).intersection(
                Line(
                    frontBrink.point2,
                    behindBrink.point3
                )
